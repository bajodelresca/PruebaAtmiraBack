...
public class Converter {
    ...
    public static String toJsonString(Asteroids obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerFor(Asteroids.class);
        writer = mapper.writerFor(Asteroids.class);
    }
